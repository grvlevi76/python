...
#can i just give elements inside eval() without using input()
...
#last left -> creating nested list in range od index of list without eval(input()) combination
...
#or 
x[2] = eval(input("enter nested list x[2] elements : "))   #enter 3,4
print("list x -> ",x)
...
#observation ->
#enter nest list elements through append() goes inside [ ] breacket but through eval() element goes inside ( ) breacket
